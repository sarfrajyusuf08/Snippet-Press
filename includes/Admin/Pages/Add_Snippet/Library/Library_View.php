...
class Library_View {
     ...
     * @param array<string, array{label:string,count:int}> $tags Map of tag slug => details (unused, retained for backward compatibility).
     */
     ...
     */
    private function render_catalog( array $snippets ): void {
        ...
        foreach ( $snippets as $snippet ) {
            ...
            $this->card_renderer->render( $snippet );
        }
